...
$title='Hot Manga';
$dataHM=mysqli_query($conn, "select * from manga where active=1 order by views desc");
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-lg-8 col-12">
              <h1 class="m-0 text-dark"> Black & White - Hot Manga</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
          <hr>
        </div><!-- /.container-fluid -->
              ...
              <div class="card card-primary card-outline">
                <div class="card-body">
                  <div class="table-responsive">
                      <table class="table table-striped dt-table" id="manga-table">
                          <thead>
                            <tr>
                              <th class="no-sort"></th>
                              <th>Manga Details</th>
